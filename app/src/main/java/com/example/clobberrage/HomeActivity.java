...
import com.example.clobberrage.Admin.AdminMaintainProductsActivity;
        ...
        implements NavigationView.OnNavigationItemSelectedListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        if (!type.equals("Admin"))
        {
            userNameTextView.setText(Prevalent.currentLogedInUser.getName());
            Picasso.get().load(Prevalent.currentLogedInUser.getImage()).placeholder(R.drawable.profile).into(profileImageView);
        }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        } else if (id == R.id.nav_caterories)
        {
            if (!type.equals("Admin"))
            {
                startActivity(new Intent(HomeActivity.this,ProductsCategoryListActivity.class));
            }
